...
export default function EditProfile(props) {
  ...
  const checkIfOneImage = ()=>{

    const resultImage = images.every((element) => {
        return (element.preview === null && element.file === null);
    });    
    const resultLinks = imageLink.every((element) => {
      return element === null;
    });
    return (resultImage && resultLinks);
  }
