...
const usersTable = {
    sql: `CREATE TABLE IF NOT EXISTS users(id VARCHAR(255) PRIMARY KEY, username VARCHAR(255), firstName VARCHAR(255), lastName VARCHAR(255),
        ...
        lastNotification DATETIME, gender VARCHAR(255), interessted VARCHAR(255), biography VARCHAR(255), bornDate DATETIME, verified BOOLEAN, infoCompleted BOOLEAN, minAge INT, maxAge INT, maxDistance INT, frameRate INT, reports INT)`,
